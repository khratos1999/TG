...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Clasificacion de suelos'),
      ),
      body: ListView(
        children: <Widget>[
          Card(
            child: new Column(
              children: <Widget>[
                new Container(
                  ...
                  child: new Text('Clasificacion de suelos S.U.C.S'),
                ),
                new Container(
                  child: new Plot(
                    height: 200.0,
                    data: data,
                    gridSize: new Offset(2.0, 5.0),
                    style: new PlotStyle(
                      pointRadius: 4.0,
                      outlineRadius: 1.0,
                      ...
                      axis: Colors.blueGrey[800],
                      gridline: Colors.blueGrey[300],
                    ),
                    padding: const EdgeInsets.fromLTRB(40.0, 12.0, 12.0, 40.0),
                    xTitle: 'Indice de Plasticidad',
                    yTitle: 'Limite Liquido',
                  ),
                ),
              ],
            ),
            ...
            child: Column(
              children: <Widget>[
                new Container(
                  ...
                  child: new Text('Clasificacion de suelos AASTHO'),
                ),
                new Container(
                  child: new Plot(
                    height: 200.0,
